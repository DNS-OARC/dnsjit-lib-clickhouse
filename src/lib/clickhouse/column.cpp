...
lib_clickhouse_column_t* lib_clickhouse_column_array_new(enum lib_clickhouse_column_type type)
{
    ColumnRef* column;

    switch (type) {
    case LIB_CLICKHOUSE_COLUMN_TYPE_INT8:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnInt8>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_INT16:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnInt16>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_INT32:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnInt32>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_INT64:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnInt64>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_UINT8:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnUInt8>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_UINT16:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnUInt16>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_UINT32:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnUInt32>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_UINT64:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnUInt64>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_STRING:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnString>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_IPV4:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnIPv4>()));
        break;
    case LIB_CLICKHOUSE_COLUMN_TYPE_IPV6:
        column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnIPv6>()));
        break;
    default:
        mlfatal("invalid type");
    }
...
lib_clickhouse_column_t* lib_clickhouse_column_array_new_datetime64(int decimals)
{
    ColumnRef* column = new ColumnRef(std::make_shared<ColumnArray>(std::make_shared<ColumnDateTime64>(decimals)));

    return (lib_clickhouse_column_t*)column;
}

void lib_clickhouse_column_array_append(lib_clickhouse_column_t* _self, lib_clickhouse_column_t* column)
{
    if (auto arr = (*self)->As<ColumnArray>()) {
        arr->AppendAsColumn(*(ColumnRef*)column);
    }
}
